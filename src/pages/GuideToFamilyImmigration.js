...
const GuideToFamlyImmigration = () => {
    const currentPage = 1;
    useEffect(() => {
        document.title = 'Guide To Family Immigration | GIT Global';
    }, []);
    return (  
        <>
            <Helmet>
                <title>Guide To Family Immigration | GIT Global</title>
                <meta
                name="description"
                content="Guide to Family Immigration by GIT Global. Expert consultants in Iowa helping families with visas, green cards, and U.S. immigration support."
                />
                <link rel="canonical" href="https://gitsiowa.com/how-to-bring-your-family-to-the-u-s-a-guide-to-family-based-immigration" />
            </Helmet>
