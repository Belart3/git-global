const BtnBlue = ({title, src}) => {
    return ( 
        <button className="border border-BL500 bg-BL500 hover:bg-BL500/75 py-4 px-6 flex  flex-row items-center justify-center space-x-3 cursor-pointer  max-w-400 w-full sm:max-w-44 transition ease-in-out delay-75 group">
            <p className="text-base leading-4 capitalize text-white ibm-plex-sans-regular">
                {title}
            </p>
