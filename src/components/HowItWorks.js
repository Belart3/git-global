...
const HowItWorks = () => {
    return ( 
        <section className="flex flex-col justify-center items-center mx-4 md:mx-8 lg:mx-20 max-w-screen-2xl 2xl:px-0 2xl:mx-auto gap-10 mb-32">
            <SectionHeading title="How Our Immigration Prepare Services Work" src="images/how-it-works.svg"/>
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:place-items-center">
