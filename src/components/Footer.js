                        ...
                        <ul className="flex flex-col items-start gap-5">
                            {
                                footerData.links.map((link) => (
                                    <Link to={link.href} key={link.id} className="text-white capitalize ibm-plex-sans-regular text-sm/5">
                                        {link.title}
                                    </Link>
                                ))
                            }
                        </ul>
                        <p className="text-white text-sm/5 ibm-plex-sans-regular flex items-center gap-2">
